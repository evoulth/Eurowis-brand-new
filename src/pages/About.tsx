      ...
      <div className="container mx-auto px-4">
        ...
        <ScrollAnimation className="text-center mb-20">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            About <span className="font-bold bg-gradient-to-r from-pink-bright to-pink-deep bg-clip-text text-transparent">euroWiskids</span>
          </h1>
          ...
          <div className="mt-10 space-y-3">
            <p className="font-bold bg-gradient-to-r from-pink-bright to-pink-deep bg-clip-text text-transparent">
          ...
          <Card className="max-w-5xl mx-auto ">
            <CardHeader>
              <CardTitle className="text-2xl flex gap-2">
                🌱 <span className="font-Bold font-bold bg-gradient-to-r from-pink-bright to-pink-deep bg-clip-text text-transparent ">About EUROWISKIDS Preschool & Early Childhood Program</span>
              </CardTitle>
            </CardHeader>
        ...
        <section className="mb-24">
          <ScrollAnimation className="text-center mb-12">
            <h2 className="text-3xl font-bold ">
              <span className="font-bold bg-gradient-to-r from-pink-bright to-pink-deep bg-clip-text text-transparent">Our Learning Levels</span>
            </h2>
          </ScrollAnimation>
                ...
                <Card className="rounded-2xl bg-background shadow-card hover:shadow-hover transition-all duration-300 h-full">
                  <CardHeader>
                    <div className="flex items-center justify-between">
                      <CardTitle className="text-xl font-bold font-bold bg-gradient-to-r from-pink-bright to-pink-deep bg-clip-text text-transparent">
                        {lvl.title}
                      </CardTitle>
                      <Badge>{lvl.age}</Badge>
                    </div>
                  ...
                  <CardContent>
                    <h4 className="font-semibold mb-4 flex items-center gap-2 font-bold bg-gradient-to-r from-pink-bright to-pink-deep bg-clip-text text-transparent">
                      <BookOpen className="w-4 h-4 font-bold bg-gradient-to-r from-pink-bright to-pink-deep bg-clip-text text-transparent" />
                      Focus Areas
                    </h4>
        ...
        {/* TEAM */}
        <ScrollAnimation className="mb-24">
          <h2 className="text-3xl font-bold text-center mb-12 font-bold bg-gradient-to-r from-pink-bright to-pink-deep bg-clip-text text-transparent">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-5xl mx-auto">
            <div className="flex flex-col items-center gap-3">
              ...
              />
              <p className="text-center font-semibold text-muted-foreground font-bold bg-gradient-to-r from-pink-bright to-pink-deep bg-clip-text text-transparent">Faculty Team</p>
            </div>
            <div className="flex flex-col items-center gap-3">
              <img
                src={caregiversTeam}
                ...
                className="w-full rounded-2xl"
              />
              <p className="text-center font-semibold text-muted-foreground font-bold bg-gradient-to-r from-pink-bright to-pink-deep bg-clip-text text-transparent">Caregivers Team</p>
            </div>
          </div>
        </ScrollAnimation>
        ...
        <section className="mb-24">
          <ScrollAnimation className="text-center mb-12">
            <h2 className="text-3xl font-bold font-bold bg-gradient-to-r from-pink-bright to-pink-deep bg-clip-text text-transparent">
                ...
                <div className="bg-gradient-to-br from-pink-bright to-blue-deep p-[2px] rounded-2xl">
                  <Card className="rounded-2xl bg-background h-full hover:shadow-hover transition-all duration-300">
                    ...
                    <CardContent className="pt-6 pb-8">
                      <h3 className="font-bold bg-gradient-to-r from-pink-bright to-pink-deep bg-clip-text text-transparent">
                        {member.name}
                      </h3>
        ...
        <section className="mb-24">
          <ScrollAnimation className="text-center mb-12">
            <h2 className="text-3xl font-bold ">
              Our Caregivers – <span className="font-bold bg-gradient-to-r from-pink-bright to-pink-deep bg-clip-text text-transparent">The Heart of Our Early Years Environment</span>
            </h2>
              ...
              <CardContent className="p-8">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-center">
                  ...
                  <div className="md:col-span-2 text-left space-y-4">
                    <h3 className="text-2xl font-bold font-bold bg-gradient-to-r from-pink-bright to-pink-deep bg-clip-text text-transparent">
                      School Head
                    </h3>
